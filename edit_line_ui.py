...
# Form implementation generated from reading ui file 'edit_line.ui'
#
...
#################################################
from currency import get_currency_list
...
######################
    ...
    def retranslateUi(self, edit_ui):
        ...
        for i in range(0,45):
            ...
            self.comboBox_4.setItemText(i, _translate("edit_ui",''.join(currencies[i+1])))
        #####################################
